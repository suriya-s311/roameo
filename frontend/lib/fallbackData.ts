...
export const FALLBACK_PRODUCTS = [
  ...
  {
    id: "prod-6",
    name: "Traditional Bronze Temple Bell & Nataraja",
    description: "Masterpiece lost-wax cast bell metal handcrafted by state award-winning sthapathis of the Chola bronze tradition.",
    price: 1200,
    category: "Handicraft",
    image_url: "https://images.unsplash.com/photo-1544735716-392fe2489ffa?w=800",
  ...
  {
    id: "prod-8",
    name: "Auroville Botanical Handmade Journal",
    description: "Eco-friendly natural pressed-flower journal made with 100% cotton rag paper by Auroville community artisans.",
    price: 420,
    category: "Stationery",
  ...
  {
    id: "prod-9",
    name: "Traditional Stone Ganesha Sculpture",
    description: "Hand-carved granite Ganesha idol crafted by 5th generation Mahabalipuram sculptors from single granite block.",
    price: 1250,
    category: "Handicraft",
    image_url: "https://images.unsplash.com/photo-1567591370504-ce57d91f9905?w=600",
    images: ["https://images.unsplash.com/photo-1567591370504-ce57d91f9905?w=600"],
    location: "Mahabalipuram",
    stock: 15,
    seller_name: "Mahabalipuram Stone Arts",
    shop_name: "Mahabalipuram Stone Arts",
  ...
  {
    id: "prod-10",
    name: "Coastal Natural Wind Chime",
    description: "Authentic wind chime handmade with Coromandel coast natural shells producing tranquil harmonic sounds.",
    price: 350,
    category: "Decor",
    ...
    shop_name: "Sea Shore Handicrafts",
    verified: true,
  },
  {
    id: "prod-11",
    name: "Sacred 108 Rudraksha Beads Rosary",
    description: "Certified authentic five-mukhi sacred rudraksha rosary blessed at the historic Ramanathaswamy Temple shores.",
    price: 890,
    category: "Religious",
    image_url: "https://images.unsplash.com/photo-1599508704512-2f19efd1e35f?w=600",
    images: ["https://images.unsplash.com/photo-1599508704512-2f19efd1e35f?w=600"],
    location: "Rameswaram",
    stock: 25,
    seller_name: "Rameswaram Shell Crafts",
    shop_name: "Rameswaram Shell Crafts",
  ...
  {
    id: "prod-12",
    name: "Heritage Waxed Canvas Travel Backpack",
    description: "Weather-resistant canvas explorer daypack with padded camera slots and genuine brass hardware.",
    price: 1850,
    ...
    shop_name: "Farhan Ali Gear",
    verified: true,
  },
  {
    id: "prod-13",
    name: "Madurai Temple & Food Night Trail",
    description: "Guided 3-hour walking exploration of Meenakshi temple heritage corridors and night food markets.",
    price: 999,
    category: "Guided Experience",
    image_url: "https://images.unsplash.com/photo-1609766857041-ed402ea8069a?w=600",
    images: ["https://images.unsplash.com/photo-1609766857041-ed402ea8069a?w=600"],
    location: "Madurai",
    stock: 30,
    seller_name: "Madurai Heritage Guild",
    shop_name: "Madurai Heritage Guild",
    verified: true,
  },
  {
    id: "prod-14",
    name: "Pamban Bridge Sunrise Kayak Tour",
    description: "Scenic morning ocean kayaking expedition near historical Pamban waters with licensed instructor.",
    price: 1499,
    category: "Guided Experience",
    ...
    shop_name: "Island Eco Excursions",
    verified: true,
  },
];

export function getFilteredFallbackProducts(paramsStr?: string) {
  if (!paramsStr) return FALLBACK_PRODUCTS;
  ...
  if (loc) {
    res = res.filter(p => (p.location || '').toLowerCase().includes(loc.toLowerCase()));
  }
  if (search) {
  ...
  return res.length > 0 ? res : FALLBACK_PRODUCTS;
}
